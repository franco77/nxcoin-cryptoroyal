<?php 
	$this->template->title->set('Active Bonus');
			...
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
    					...
    					$this->db->where('bonus_type', 'active'); 
				...
				<tfoot>
					...
					?>
					<tr>
						<td colspan="4" class="text-right"><?php echo $this->paginationmodel->paginate( 'bonus-active' , $num_rows, $limit_per_page ); ?></td>
					</tr>
				</tfoot>
			</table>
		</div>
