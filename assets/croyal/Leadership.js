$(document).ready(function() {
    $.fn.CrLeadership = function(options) {
        ...
        var url_update_star = env.site_url +'/leadership/update_star';
        var _this = this;
        var detail_template = `
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <label for="">Referral with minimum staking amount <span id="ach_ref_min_staking"></span> <span id="ach_ref_label"><span> </label>
        ...
        `;
        var temp_achievment_complete = `
            <div class="card">
                <div class="card-body">
                    <h1>All achievments complete</h1>
                </div>
            </div>
        `;
        ...
        this.build = function(data) {
            var $temp;
            if(data.achivements.star < 4) {
                $temp       = $(detail_template);
                ...
                $temp.find("#ach_ref_min_staking").html(NEXT_ACHIVEMENT.min_invest);
